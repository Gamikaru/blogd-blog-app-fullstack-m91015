...
// Create PostContext for managing posts globally
...
const AppLayout = () => {
   ...
   const [userPosts, setUserPosts] = useState([]); // Centralized state to track user posts
   ...
   // Centralized function to handle new posts
   ...
   return (
      <PostContext.Provider value={{ userPosts, handleNewPost }}>  {/* Provide posts and handler */}
         <div className="app-layout">
            ...
            <Outlet />  {/* Content will consume userPosts via PostContext */}
         </div>
